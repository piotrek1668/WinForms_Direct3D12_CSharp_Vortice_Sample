...
namespace DirectX3D12Example
{
    public partial class MainWindow : Form
    {
        ...
        private void InitializeAdditionalControls()
        {
            ...
            Label leftLabel = new()
            {
                Location = new Point((this.leftControl.Location.X + (this.rightControl.Size.Width / 2)) - 50, leftControl.Location.Y + leftControl.Height),
            ...
            {
                Location = new Point((this.rightControl.Location.X + (this.rightControl.Size.Width / 2)) - 50, rightControl.Location.Y + rightControl.Height),
                Size = new Size(100, 40),
        ...
        {
            if (this.graphicDevice is { Initialized: true })
            {
